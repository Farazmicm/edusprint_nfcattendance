class SchoolGroupWiseLoginModel {
  ...
  SchoolGroupWiseLoginModel.fromJson(Map<String, dynamic> json) {
    MBMClientKeyValuePair =
        List.castFrom<dynamic, dynamic>(json['MB_M_ClientKeyValuePair']);
    MBMBBPSHostToHostDetail =
        List.castFrom<dynamic, dynamic>(json['MB_M_BBPSHostToHostDetail']);
